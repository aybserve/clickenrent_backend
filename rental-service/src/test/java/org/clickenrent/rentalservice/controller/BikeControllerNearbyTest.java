...
class BikeControllerNearbyTest {
    ...
    void testGetNearbyBikes_Success() throws Exception {
        ...
        BikeLocationDTO bike2 = BikeLocationDTO.builder()
                ...
                .bikeStatus(1L)
                .bikeStatusName("Available")
                .batteryChargeStatus(3L)
                .batteryChargeStatusName("Fully charged")
                .location(GeoPointDTO.builder()
        ...
        mockMvc.perform(get("/api/bikes/nearby")
                ...
                .andExpect(jsonPath("$.bikes[0].code").value("EB001"))
