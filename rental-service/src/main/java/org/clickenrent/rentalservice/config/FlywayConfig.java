 ...
 *
 * <p><b>PostGIS Note:</b> The PostGIS extension is created in a pre-Hibernate
 * initialization step (see {@link PostGISExtensionConfig}) because Hibernate needs
 * the {@code geography} type to exist when creating the coordinates table.</p>
 *
