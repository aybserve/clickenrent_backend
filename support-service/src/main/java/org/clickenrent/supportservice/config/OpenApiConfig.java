...
/**
 * OpenAPI/Swagger configuration for Support Service
...
public class OpenApiConfig {
    ...
    public OpenAPI supportServiceOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("Click & Rent Support Service API")
                        .description("Support Management Service for Click & Rent Platform. " +
                                "Manages tickets, customer support, feedback, and help requests.")
                        .version("1.0.0")
                        .contact(new Contact()
