...
-- 1.2 PAYMENT METHOD
-- ---------------------------------------------------------------------------------------------------------------------
-- Insert/Update payment methods using UPSERT (works on both empty and existing databases)
-- IDs are auto-generated by PostgreSQL sequence for new records
-- Existing records are updated with latest information
...
-- =====================================================================================================================
-- SECTION 2: SAMPLE/TEST DATA (OPTIONAL) - COMMENTED OUT FOR PRODUCTION
-- =====================================================================================================================
...
-- UNCOMMENT if needed for development/testing, but keep COMMENTED for production.
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.2 USER PAYMENT METHODS (Sample data) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.3 FINANCIAL TRANSACTIONS (Sample data) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
-- Stripe transactions
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.4 RENTAL FIN TRANSACTIONS (Sample data - references rentals from rental-service) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.5 B2B SALE FIN TRANSACTIONS (Sample data - references B2B sales from rental-service) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.6 B2B SUBSCRIPTION FIN TRANSACTIONS (Sample data) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.7 LOCATION BANK ACCOUNTS (Sample data for payout testing) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.8 B2B REVENUE SHARE PAYOUTS (Sample data - references companies from auth-service) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.9 B2B REVENUE SHARE PAYOUT ITEMS (Sample data) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- 2.10 PAYOUT FIN TRANSACTIONS (Sample data - links payouts to financial transactions) - COMMENTED OUT FOR PRODUCTION
-- ---------------------------------------------------------------------------------------------------------------------
